...
useEffect(() => {
  const fetchProfileData = async () => {
    try {
      ...
      const userProfileRes = await api.get('/profile/biodata');
      const userData: User = userProfileRes.data;
      setUser(userData);
      ...
      // Fetch education
      const educationRes = await api.get('/profile/education');
      setEducation(educationRes.data.education || educationRes.data || []);

      // Fetch work experience
      const experienceRes = await api.get('/profile/experience');
      setWorkExperience(experienceRes.data.experience || experienceRes.data || []);

      // Fetch skills
      const skillsRes = await api.get('/profile/skills');
