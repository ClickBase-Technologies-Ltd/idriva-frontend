          ...
          <div>
            <div className="bg-white border border-gray-300 rounded-lg shadow-md p-10">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <button type="submit" disabled={isLoading} className="w-full bg-[#0A66C2] hover:bg-[#004182] text-white py-3 rounded-full text-base font-semibold transition-all shadow">
                  {isLoading ? "Creating account..." : "Agree & Join iDriva"}
                </button>
                ...
                <button type="button" onClick={() => router.push("/auth/login")} className="w-full border border-gray-500 text-gray-700 hover:bg-gray-100 py-3 rounded-full text-base font-semibold">
